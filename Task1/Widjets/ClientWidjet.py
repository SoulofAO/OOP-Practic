...
class UClientWidjet(UEditClassWidjet):
    ...
    def InitUI(self):
        ...
        self.WTextSecondNameEdit = QLineEdit()
        ...
        self.WTextPassportEdit = QLineEdit()
    ...
    def AddNew(self):
        Name = self.WTextNameEdit.text()
        Family = self.WTextFamilyEdit.text()
        Second_Name = self.WTextSecondNameEdit.text()
        passport = self.WTextPassportEdit.text()
